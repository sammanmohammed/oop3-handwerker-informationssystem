...
public class Adresse implements Serializable {
	...
	public Adresse(int adresseId, String strasse, String hausnr, String plz, String ort) {
	...
	public AdresseTO toTo(){
		return new AdresseTO(adresseId, strasse, hausnr, plz, ort);
	}
